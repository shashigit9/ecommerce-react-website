                            ...
                            {cartItems.map((item)=>(
                                ...
                                className="checkout-item-image"
                                 ...
                                 <div className="checkout-item-controls">
                                    <button className="quantity-btn1" onClick={()=>updateQuantity(item.id,item.quantity-1)}>-</button>
                                    <span className="quantity-value" >{item.quantity}</span>
                                    <button className="quantity-btn2" onClick={()=>updateQuantity(item.id,item.quantity+1)}>+</button>
                                 </div>

                                 <p className="check-item-total">
